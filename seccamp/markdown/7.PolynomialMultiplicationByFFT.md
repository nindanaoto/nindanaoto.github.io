...
$$
A_t = ∑^{N-1}_{x=0} a_x⋅e^{-i\frac{2πtx}{N}}=\begin{cases}∑^{\frac{N}{2}-1}_{x=0} (a_{2x}+a_{2x+1})⋅e^{-i\frac{2πtx}{\frac{N}{2}}} \qquad if\quad t≡0 \bmod 2\\∑^{\frac{N}{2}-1}_{x=0} [(a_{2x}-a_{2x+1})⋅e^{-i\frac{2πtx}{N}}]⋅e^{-i\frac{2πtx}{\frac{N}{2}}} \end{cases}
$$
